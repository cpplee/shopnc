...
<?php }?>
<div id='main-nav'>
  <div id='main-nav-wrap'style="width:1200px;">
    <ul>
      ...
      <li><span class="split-line">
        <a <?php if((string)$output['index_sign'] == $nav['nav_byname']){echo 'class="current"';}else{echo 'class=""';} ?><?php if($nav['nav_new_open']){?>target="_blank" <?php }?> href="<?php switch($nav['nav_type']){
